...
@section('content')
    <div class="container ">
        ...
        <div class="card-style ">
            ...
            <div class="card-body">
                <form action="/api/users/{{ $data['id'] }}" method="post" id="data" class="createdata"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="first_name" id="first_name"
                                placeholder="Masukkan nama depan" value="{{ $data['first_name'] }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="last_name" id="last_name"
                                placeholder="Masukkan nama belakang" value="{{ $data['last_name'] }}">
                        </div>
                    </div>
                    <div class="row mb-3">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    setTimeout(function() { // wait for 1 secs(2)
                        window.location = '/dashboard/user'; // then reload the page.(3)
                    }, 1000);
                },
