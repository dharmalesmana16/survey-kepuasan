...
@section('content')
    <div class="container ">
        ...
        <div class="card-style ">
            ...
            <div class="card-body">
                <form action="{{ url('/api/video') }}" method="post" id="data" class="createdata"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="judul_video" id="judul_video"
                                placeholder="Masukkan Judul Video" value="">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input class="form-control" type="file" name="file_video">
                        </div>
                    </div>
                    <div class="text-end">
